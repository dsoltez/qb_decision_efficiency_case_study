#Create a variable and load play-by-play for 2021 season
pbp_2021 <- load_pbp_seasons(2021)

#Create another variable and load the prep_qb_pbp function
pbp_2021_qb <- prep_qb_pbp(pbp_2021)

#Create a final variable for the decision_effective_pbp %
pbp_2021_qb_decisions <- add_decision_effective(pbp_2021_qb)

#Summarize Quarterback play for the 2021 season
qb_2021_summary <- summarise_qb_season(pbp_2021_qb_decisions)

#Filter to no less than 300 dropbacks
qb_2021_summary <- qb_2021_summary %>%
  dplyr::filter(dropbacks >= 300) 

#Create the table and filter through the 2021 season
...
#Left_join the tables to qb_2021_summary
qb_2021_summary <- qb_2021_summary %>%
...
#Create a .csv file
write.csv(qb_2021_summary, "qb_2021_summary.csv", row.names = FALSE)
