...
#Summarize Quarterback play for the 2022 season
...
#Create the table and filter through the 2022 season
...
#Left_join the tables to qb_2022_summary
qb_2022_summary <- qb_2022_summary %>%
...
#Create a .csv file
write.csv(qb_2022_summary, "qb_2022_summary.csv", row.names = FALSE)
