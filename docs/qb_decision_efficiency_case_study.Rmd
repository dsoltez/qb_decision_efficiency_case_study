...
**Summary (Q3):**\
This four-year trend visualization is designed to reveal how consistently each quarterback maintains their Decision Rate over time, focusing only on **QBs** with all four seasons and at least 300 dropbacks per year. Faceted Line charts are ideal here because they highlight trajectory, not just performance snapshots — improving the visuals improvement, decline, or stability across 2021–2024.

**Key findings from the graphs:**\
Several quarterbacks show clear upward progression in their decision-making discipline. **Baker Mayfield**, **Jared Goff**, **Lamar Jackson**, and **Tua Tagovailoa** all end 2024 at or near their highest Decision Rate over the entire sample, signaling refinement and stability as their offensive situations matured. Others display remarkable steadiness year over year — including **Josh Allen**, **Jalen Hurts**, and **Patrick Mahomes** — whose lines remain tightly clustered with minimal variance, reflecting highly stable processing and decision-making frameworks.

A smaller group demonstrates more volatility. **Dak Prescott** peaks in 2022 before declining noticeably by 2024, while **Trevor Lawrence** and **Justin Herbert** show slight downward slides after early-season highs. **Russell Wilson** is the most inconsistent, bottoming out in 2022 before bouncing back. **Joe Burrow** stays mostly steady but shows a brief dip in 2023 before recovering in 2024.

Overall, these trends provide essential context for DEI: they show not just who grades well on average, but how each quarterback arrived at those outcomes—whether through gradual improvement, consistent excellence, or fluctuating year-to-year performance.
